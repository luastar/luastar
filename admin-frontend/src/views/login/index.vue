<template>
  <div class="login">
    ...
    <div class="login-footer">
      <el-text size="small">
        Copyright © 2025 Luastar All Rights Reserved.
        <a href="http://www.luastar.com/" target="_blank"
          >京ICP备2024057516号-1</a
        >
      </el-text>
    </div>
  </div>
...
const toggleTheme = () => {
  const newTheme =
    settingsStore.theme === ThemeMode.DARK ? ThemeMode.LIGHT : ThemeMode.DARK;
